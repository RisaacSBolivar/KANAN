...
def deteccionUnica(img_):
    ...
    #path1_2 = os.path.abspath(__file__)[:-10] + '/yolov3.weights'
    #path2_2 = os.path.abspath(__file__)[:-10] + '/yolov3.cfg'
    ...
    for out in outs:
        ...
        for ii in range(len(boxes)):
            if ii in indexes:
                ...
                #(0,255,0)
                cv2.putText(img, classes[class_ids[ii]], (x, y + 30), font, 3, (30,144,255), 2)
                #cv2.putText(img, classes[class_ids[ii]], (x, y + 30), font, 2, (0,255,0), 2)
                detecciones.append(classes[class_ids[ii]])
