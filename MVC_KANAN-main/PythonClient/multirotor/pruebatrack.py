...
def drawBox(img,bbox):
    ...
    cv2.putText(img," Diff x= " + str(round(abs((xt/2)-x_c)/(xt/2),2)),(75,125),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,255,0),2)
    cv2.putText(img," Diff y= " + str(round(abs((yt/2)-y_c)/(yt/2),2)),(75,150),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,255,0),2)
